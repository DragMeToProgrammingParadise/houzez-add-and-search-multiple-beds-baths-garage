...
function houzez_information_metabox_fields( $metabox_fields ) {
	...
	$fields = array(
        ...
        array(
            ...
            'placeholder' => houzez_option('cl_bedrooms_plac', 'Enter bedrooms (e.g., 1,3,4)'),
            'desc' => houzez_option('cl_only_digits', 'Comma separated values'),
            'type' => 'text',
            'std' => "",
            'columns' => 6,
            'tab' => 'property_details',
    ...
    'desc' => houzez_option('cl_only_digits', 'Enter multiple garage values separated by commas (e.g., 1,2,3)'),
    'type' => 'text',  // Keeping the type as text for comma-separated values
    'std' => "",       // Default value (empty)
    'columns' => 6,    // Column size in the admin layout
    'tab' => 'property_details',
),
